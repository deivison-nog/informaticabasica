...
<div class="lesson-content">
  ...
  <p>
    ...
    informações entre pessoas, empresas e governos em todo o mundo. Ela funciona através de
    cabos, satélites e ondas de rádio (Wi-Fi).
  </p>
  <p>
  ...
  <ul>
    ...
    <li><strong>URL</strong>: endereço de um site. Ex: <code>www.google.com</code></li>
  ...
  <div class="table-responsive">
    <table class="table table-bordered table-sm">
      <thead class="table-info">
        <tr><th>Campo</th><th>Função</th></tr>
      </thead>
      <tbody>
        <tr><td><strong>Para</strong></td><td>Endereço do destinatário principal.</td></tr>
        <tr><td><strong>CC</strong></td><td>Cópia — outros recebem e todos sabem quem recebeu.</td></tr>
        <tr><td><strong>CCO / BCC</strong></td><td>Cópia oculta — outros recebem, mas não sabem uns dos outros.</td></tr>
        <tr><td><strong>Assunto</strong></td><td>Resumo do tema da mensagem.</td></tr>
        <tr><td><strong>Corpo</strong></td><td>O texto principal da mensagem.</td></tr>
  ...
  <ul>
    ...
    <li>Confirme o destinatário antes de enviar.</li>
  ...
  <h6 class="fw-semibold">Extensões de arquivo mais comuns</h6>
  <div class="row g-2">
    <div class="col-sm-6">
      <ul class="list-group list-group-flush small">
        <li class="list-group-item"><code>.docx</code> — Documento de texto (Word)</li>
        <li class="list-group-item"><code>.xlsx</code> — Planilha (Excel)</li>
        <li class="list-group-item"><code>.pptx</code> — Apresentação (PowerPoint)</li>
        <li class="list-group-item"><code>.pdf</code>  — Documento portátil</li>
      </ul>
    </div>
    <div class="col-sm-6">
      <ul class="list-group list-group-flush small">
        <li class="list-group-item"><code>.jpg / .png</code> — Imagem</li>
        <li class="list-group-item"><code>.mp4 / .avi</code> — Vídeo</li>
        <li class="list-group-item"><code>.mp3</code>        — Áudio</li>
  ...
  <div class="alert alert-info mt-4">
    ...
    <ul class="mb-0 mt-1">
      ...
      <li><strong>Download/Upload</strong>: baixar e enviar arquivos.</li>
      <li><strong>E-mail</strong>: comunicação digital com campos definidos.</li>
  ...
  <div class="card border-secondary mt-3">
    ...
    <div class="card-body">
      <ol>
        <li>Crie uma estrutura de pastas para organizar os arquivos de suas disciplinas.</li>
        <li>Identifique as extensões: <code>foto_viagem.jpg</code>, <code>trabalho.docx</code>, <code>musica.mp3</code>.</li>
        <li>Escreva um e-mail formal solicitando informações sobre um curso.</li>
      </ol>
    </div>
  </div>
</div>
